...
* The LinearRegression files are used in the calibrate functions. We used some file's from [cubiwan's](https://github.com/cubiwan) repo [LinearRegressino](https://github.com/cubiwan/LinearRegressino)
